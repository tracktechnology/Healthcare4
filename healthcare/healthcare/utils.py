...
def get_encounters_to_invoice(patient, company):
	...
	encounters = frappe.get_list(
		"Patient Encounter",
		fields=["*"],
		filters={"patient": patient, "company": company, "invoiced": False, "docstatus": 1,"reservation_type":"Clinics"},
	)
	if encounters:
...
def manage_invoice_validate(doc, method):
	if doc.get("service_unit")  and len(doc.items):
