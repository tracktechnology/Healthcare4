...
def get_data(filters=None):
	...
	patient_encounters=frappe.db.sql(f"Select name,patient,reservation_type,practitioner,medical_department from`tabPatient Encounter` where {upper_encounter_date} and {lower_encounter_date}  and docstatus!=0 and reservation_type='Laboratory' ",as_dict=1 )
